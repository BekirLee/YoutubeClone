            ...
            <div className=" text-white leading-8 mt-4 mb-3">
                ...
                <div className="flex gap-2 items-center mt-3 h-14 justify-between">
                    <div className="flex gap-4">
                        ...
                        <div className="btnSubParent hover:bg-[#ffffff8d] rounded-full text-black font-bold ">
                            <button className='subBtn h-full'
                                onClick={subscriber}>
                                {
                                    !subscribed ? <div className='bg-white p-1 rounded-full h-full'>Subscribe</div> : <div className="innerSubBtn w-[170px] h-full flex items-center p-1 rounded-full hover:bg-neutral-600 ">
