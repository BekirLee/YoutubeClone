...
function HiddenGuide() {
    return (
        ...
        <div className="section2  w-[64px] h-full pb-3 z-[55] bg-[#0f0f0f] fixed pt-[77px] text-center px-[4px] transition-all duration-300 ease-in-out">
            <div className="section2Item text-center py-4">
